  ...
  "inline-flex items-center justify-center text-muted-foreground font-poppins gap-2",
  {
    variants: {
      variant: {
        ...
        rounded: "bg-white dark:bg-[#121214] p-2 rounded-full ",
  ...
  "inline-flex items-center justify-center whitespace-nowrap px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        rounded:
          "rounded-full data-[state=active]:bg-primary data-[state=active]:font-semibold data-[state=inactive]:hover:bg-primary/5 data-[state=active]:text-primary-foreground",
        folder:
