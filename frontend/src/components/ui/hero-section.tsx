    ...
    <>
      ...
      <section className="bg-[url('https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/hero/gridBackground.png')] w-full bg-no-repeat bg-cover bg-center text-sm pb-44 h-full">
        <nav className="flex items-center justify-between p-4 md:px-16 lg:px-24 xl:px-32 md:py-6 w-full">
          ...
          >
            ...
            <div className="relative group flex items-center gap-1 cursor-pointer">
              ...
              <div className="absolute bg-white font-normal flex flex-col gap-2 w-max rounded-lg p-4 top-36 left-0 opacity-0 -translate-y-full group-hover:top-44 group-hover:opacity-100 transition-all duration-300 shadow-sm">
                <a href="/policy/terms-and-conditions" className="hover:translate-x-1 hover:text-slate-500 transition-all">Terms and Condition</a>
                <a href="/policy/privacy-policy" className="hover:translate-x-1 hover:text-slate-500 transition-all">Privacy Policy</a>
                <a href="/policy/data-protection-policy" className="hover:translate-x-1 hover:text-slate-500 transition-all">Data Protection Policy</a>
                <a href="/policy/refund-policy" className="hover:translate-x-1 hover:text-slate-500 transition-all">Refund Policy</a>
              </div>
            </div>
          ...
          <a href="mailto:support@zuplin.com">
        ...
        <div className="mx-auto w-full flex items-center justify-center gap-3 mt-4">
          <button className="bg-slate-800 hover:bg-black text-white px-6 py-3 rounded-full font-medium transition" onClick={() => router.push('/login')}>
            Get Started
          </button>
