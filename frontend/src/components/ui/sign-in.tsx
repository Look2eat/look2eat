          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-end text-sm">
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); onResetPassword?.(); }} className="hover:underline text-foreground/80 transition-colors font-semibold underline">Forget password</a>
              </div>
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-muted-foreground">
              Don&apos;t have an account? <a href="#" onClick={(e) => { e.preventDefault(); onCreateAccount?.(); }} className="text-blue-500 dark:text-blue-400 font-semibold hover:underline transition-colors">Create Account</a>
            </p>
          </div>
        </div>
      </section>
