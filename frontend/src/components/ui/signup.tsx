...
export const SignUpPage: React.FC<SignUpPageProps> = ({
    ...
    description = "Enter your details to sign up for your account",
    heroImageSrc,
    testimonials = [],
    onSignUp,
}) => {
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        <form className="space-y-5" onSubmit={onSignUp}>
                            <div className="animate-element animate-delay-300 flex flex-col gap-1">
                                ...
                                <GlassInputWrapper>
                                    <input name="name" type="text" placeholder="Enter your name" className="w-full bg-transparent text-sm p-3 focus:outline-none font-medium rounded-xl " />
                                </GlassInputWrapper>
                            </div>
                            <div className="animate-element animate-delay-300 flex flex-col gap-1">
                                <label className="text-sm font-semibold text-foreground">Brand Name</label>
                                <GlassInputWrapper>
                                    <input name="brandName" type="text" placeholder="Enter your brand name" className="w-full bg-transparent text-sm p-3 focus:outline-none font-medium rounded-xl " />
                                </GlassInputWrapper>
                            </div>
                            <div className="animate-element animate-delay-300 flex flex-col gap-1">
                            ...
                            <div className="animate-element animate-delay-300 flex flex-col gap-1">
                                ...
                                <GlassInputWrapper>
                                    <input name="email" type="email" placeholder="Enter your email" className="w-full bg-transparent text-sm p-3 focus:outline-none font-medium rounded-xl " />
                                </GlassInputWrapper>
                            </div>
