...
export function TopCustomersCard({
  ...
  return (
    ...
    >
      ...
      <div className={cn(variantStyles[variant], "bg-gradient-to-br from-amber-100 to-amber-600 dark:from-[#432e16] dark:to-[#312110]", roundedStyles[rounded], "shadow-lg")}
      >
        {/* Header */}
        <motion.div
          ...
          <div className={cn(
            ...
            >
              ...
              <motion.div
                ...
                variants={shouldAnimate ? stageContainerVariants : undefined}
              >
                {customer.slice(0, 5).map((customer, index) => (
                  <motion.div
                    key={customer.id}
                    ...
                    <div className="flex justify-between w-full items-center">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          {customer.totalPointsEarned.toLocaleString()} pts earned
                        </p>
                      </div>
