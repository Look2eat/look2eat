...
exports.adminRouter.post("/brands/:brandId/images", cloudinary_service_1.uploadToCloudinary.fields([{ name: 'logo', maxCount: 1 }, { name: 'banner', maxCount: 1 }]), admin_controller_1.adminController.uploadBrandImages);
...
exports.adminRouter.get("/brands/:brandId/dashboard", admin_controller_1.adminController.getDashboard);
